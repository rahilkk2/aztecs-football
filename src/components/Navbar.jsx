    ...
    >
      <div className="page-container flex items-center justify-between">
        ...
        >
          ...
          <div
            className="w-11 h-11 rounded-full overflow-hidden border-2 border-yellow-500/60 flex items-center justify-center shrink-0"
          ...
          <div className="leading-none">
            <div
              className="text-white text-xl tracking-[3px] font-black"
              style={{ fontFamily: "'Bebas Neue', cursive" }}
            >
              AZTECS
            </div>
            <div className="text-yellow-500 text-[9px] font-bold tracking-[3px] uppercase mt-0.5">
              Football Academy
            </div>
          </div>
        </div>
