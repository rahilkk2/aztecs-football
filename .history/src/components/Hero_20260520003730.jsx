...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* ── Main Content Grid ── */}
      <div className="page-container relative z-10 w-full pt-24 sm:pt-28 md:pt-32 lg:pt-40 pb-12 sm:pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-6 sm:gap-8 lg:gap-4 min-h-[calc(100vh-10rem)] sm:min-h-[calc(100vh-12rem)]">
